...
Pstate.param{4} = {'width'      'float'      3       0                'deg'};
Pstate.param{5} = {'width2'      'float'      3       0                'deg'};

Pstate.param{6} = {'axis'      'int'     0       0                'binary'};
Pstate.param{7} = {'dir'      'int'     0       0               'binary'};
Pstate.param{8} = {'speed'      'float'     400       0                'pix/s'};
...
Pstate.param{21}= {'EyeVary'     'int'   0   0       '0=both, 1=L eye, 2= R eye'};
