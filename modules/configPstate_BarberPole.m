...
Pstate.param{7} = {'x_size'      'float'      3       0                'deg'};
Pstate.param{8} = {'y_size'      'float'      3       0                'deg'};
...
Pstate.param{21} = {'o1x_size'      'float'      3       0                'deg'};
Pstate.param{22} = {'o1y_size'      'float'      3       0                'deg'};
Pstate.param{23} = {'o1_angle'      'float'      0       0                'deg'};
...
Pstate.param{27} = {'o2x_size'      'float'      3       0                'deg'};
Pstate.param{28} = {'o2y_size'      'float'      3       0                'deg'};
Pstate.param{29} = {'o2_angle'      'float'      0       0                'deg'};
