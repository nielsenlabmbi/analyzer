...
Pstate.param{end+1} = {'speedGradient'      'int'     1       1                ''};
Pdoc.param{end+1}='1: speed gradient 0: speed planes';
Pstate.param{end+1} = {'dotLifetime'      'int'       10     1                'frames'};
Pdoc.param{end+1}='max dot lifetime';
Pstate.param{end+1} = {'noiseType'      'int'       1     1                ''};
Pdoc.param{end+1}='noise type: 0 random repos, 1 random dir';
