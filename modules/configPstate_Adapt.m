...
Pstate.param{10} = {'mask_type'   'string'   'none'       1                ''};
Pstate.param{11} = {'mask_radius' 'float'      6       0                'deg'};
...
Pstate.param{16} = {'s_profile'   'string'   'sin'       1                ''};
Pstate.param{17} = {'s_duty'      'float'   0.5       0                ''};
Pstate.param{18} = {'t_period'    'int'       20       1                'frames'};
