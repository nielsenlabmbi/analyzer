...
Pstate.param{end+1} = {'x_size'      'float'      3       0                'deg'};
Pdoc.param{end+1}='overall width of texture';
Pstate.param{end+1} = {'y_size'      'float'      3       0                'deg'};
Pdoc.param{end+1}='overall height of texture';
