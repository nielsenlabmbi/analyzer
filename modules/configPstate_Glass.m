...
Pstate.param{8} = {'ori'      'int'     0       0                ''};% angle off original dot
Pstate.param{9} = {'dotCoherence'      'int'     100       0                '%'};%coherence of motion probs as %
Pstate.param{10} = {'deltaDot'      'float'     2.5       0                'deg'}; %shift off from original dot
Pstate.param{11} = {'dotSizes'      'float'     2       1                'deg'};
Pstate.param{12} = {'nrDots'      'int'     20       1                'dots'};%number of dots
Pstate.param{13} = {'dotType'      'int'     0       0                'dots'};%number of dots
%0 = square; 1 = circle
%for dot color!
