...
Pstate.param{17} = {'dotCoherence'      'int'     100       0                '%'};
Pstate.param{18} = {'noNetNoise'      'int'     0      0            ''};
...
Pstate.param{23} = {'mask_radius2' 'float'      6      0               'deg'};
Pstate.param{24} = {'mask_type2' 'string'      'disc'      0               ''};
Pstate.param{25} = {'ori2'      'int'     0       0                'deg'};
Pstate.param{26} = {'dotDensity2'      'float'      100       0                'dots/(deg^2 s)'};
Pstate.param{27} = {'speedDots2'      'float'     5      0               'deg/s'};
Pstate.param{28} = {'dotLifetime2'      'int'     0       0                'frames'};
Pstate.param{29} = {'dotCoherence2'      'int'     100       0                '%'};
