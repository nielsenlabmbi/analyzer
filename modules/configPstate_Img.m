...
Pstate.param{11} = {'imgpath'      'string'     '~/images'       0                ''};
Pstate.param{12} = {'imgbase'      'string'     'imgRetinotopy'       1                ''};
Pstate.param{13} = {'imgnr'      'int'     1       0                ''};
Pstate.param{14} = {'filetype'      'string'     'gif'       0                ''};

Pstate.param{15} = {'color'      'int'     1       0                ''};

Pstate.param{16} = {'scramble'      'int'     0       0                ''};
Pstate.param{17} = {'nrblocks'      'int'     8       0                ''};
