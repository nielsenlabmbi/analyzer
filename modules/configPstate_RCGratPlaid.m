function configPstate_RCGratPlaid
global Pstate
...
Pstate.param{15} = {'h_per'      'int'   40       1                'frames'};
Pstate.param{16} = {'blankProb'    'float'   0.05       0                ''};

Pstate.param{17} = {'ori_diff'   'int'   125       1                'deg'};

Pstate.param{18} = {'s_freq'   'float'   0.125       1                'c/deg'};
Pstate.param{19} = {'s_profile'   'string'   'sin'       1                ''};
Pstate.param{20} = {'s_duty'      'float'   0.5       0                ''};
Pstate.param{21} = {'drift'    'int'   1         0                 'binary'};
Pstate.param{22} = {'t_period'    'int'       20       1                'frames'};
