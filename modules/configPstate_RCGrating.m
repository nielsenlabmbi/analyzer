...
Pstate.param{end+1} = {'n_sfreq' 'int'   7       0             ''};
...
Pstate.param{end+1} = {'min_tp'   'int'   30       0                'frames'};
Pdoc.param{end+1}='minimum temporal period';
Pstate.param{end+1} = {'max_tp'   'int'   30       0                'frames'};
Pdoc.param{end+1}='maximum temporal period';
Pstate.param{end+1} = {'n_tp' 'int'   1       0             ''};
...
Pstate.param{end+1} = {'min_ctr'   'int'   100       0                'frames'};
Pdoc.param{end+1}='minimum contrast';
Pstate.param{end+1} = {'max_ctr'   'int'   100       0                'frames'};
Pdoc.param{end+1}='maximum contrast';
Pstate.param{end+1} = {'n_ctr' 'int'   1       0             ''};
Pdoc.param{end+1}='number of contrasts';
Pstate.param{end+1} = {'ctr_domain'   'string'   'log'       0                ''};
Pdoc.param{end+1}='contrast spacing: log or lin';
